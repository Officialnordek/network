...
export class ConsensusUtils__factory {
  static readonly abi = _abi;
  static createInterface(): ConsensusUtilsInterface {
    return new Interface(_abi) as ConsensusUtilsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ConsensusUtils {
    return new Contract(address, _abi, runner) as unknown as ConsensusUtils;
  }
}
