...
import type { VotingUtils, VotingUtilsInterface } from "../VotingUtils";
...
export class VotingUtils__factory {
  static readonly abi = _abi;
  static createInterface(): VotingUtilsInterface {
    return new Interface(_abi) as VotingUtilsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): VotingUtils {
    return new Contract(address, _abi, runner) as unknown as VotingUtils;
  }
}
