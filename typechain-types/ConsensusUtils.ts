...
export interface ConsensusUtilsInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ConsensusUtils extends BaseContract {
  connect(runner?: ContractRunner | null): ConsensusUtils;
  waitForDeployment(): Promise<this>;

  interface: ConsensusUtilsInterface;
