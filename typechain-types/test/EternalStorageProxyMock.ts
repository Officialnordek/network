...
export interface EternalStorageProxyMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getVersion"
      | "upgradeTo"
  ...
  encodeFunctionData(
    functionFragment: "setProxyStorageMock",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface EternalStorageProxyMock extends BaseContract {
  connect(runner?: ContractRunner | null): EternalStorageProxyMock;
  waitForDeployment(): Promise<this>;

  interface: EternalStorageProxyMockInterface;
  ...
  setProxyStorageMock: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setProxyStorageMock"
  ): TypedContractMethod<[_proxyStorage: AddressLike], [void], "nonpayable">;
  getFunction(
