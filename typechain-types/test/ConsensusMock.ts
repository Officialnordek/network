...
export interface ConsensusMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "setCurrentValidatorsLengthMock"
      | "DECIMALS"
      | "withdraw(uint256)"
      ...
      | "setBlockCounterMock"
      | "setShouldEmitInitiateChangeMock"
      | "setValidatorFee"
      | "getMinStake"
      ...
      | "setStakeAmountMockGroup"
      | "isValidator"
      | "isPendingValidator"
      | "setTotalStakeAmountMock"
      | "getMaxStake"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "hasCycleEnded",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setCurrentValidatorsLengthMock",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setBlockCounterMock",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setShouldEmitInitiateChangeMock",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setValidatorFeeMock",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setNewValidatorSetMock",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFinalizedMock",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "addStakeAmountMock",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setStakeAmountMockGroup",
    values: [AddressLike[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTotalStakeAmountMock",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface ConsensusMock extends BaseContract {
  connect(runner?: ContractRunner | null): ConsensusMock;
  ...
  hasCycleEnded: TypedContractMethod<[], [boolean], "view">;
  ...
  setCurrentValidatorsLengthMock: TypedContractMethod<
    [_currentValidatorsLengthMock: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setBlockCounterMock: TypedContractMethod<
    [_val: AddressLike, counter: BigNumberish],
    [void],
    "nonpayable"
  >;

  setShouldEmitInitiateChangeMock: TypedContractMethod<
    [_status: boolean],
    [void],
    "nonpayable"
  >;
  ...
  setValidatorFeeMock: TypedContractMethod<
    [_amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setNewValidatorSetMock: TypedContractMethod<
    [_newSet: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  setFinalizedMock: TypedContractMethod<
    [_status: boolean],
    [void],
    "nonpayable"
  >;
  ...
  addStakeAmountMock: TypedContractMethod<
  ...
  setStakeAmountMockGroup: TypedContractMethod<
    [_newSet: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  setTotalStakeAmountMock: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setCurrentValidatorsLengthMock"
  ): TypedContractMethod<
    [_currentValidatorsLengthMock: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "setBlockCounterMock"
  ): TypedContractMethod<
    [_val: AddressLike, counter: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setShouldEmitInitiateChangeMock"
  ...
  getFunction(
    nameOrSignature: "setValidatorFeeMock"
  ): TypedContractMethod<[_amount: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setNewValidatorSetMock"
  ): TypedContractMethod<[_newSet: AddressLike[]], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setFinalizedMock"
  ): TypedContractMethod<[_status: boolean], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "delegatorsLength"
  ): TypedContractMethod<[_validator: AddressLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "addStakeAmountMock"
  ): TypedContractMethod<
    [addr: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "setStakeAmountMockGroup"
  ): TypedContractMethod<[_newSet: AddressLike[]], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setTotalStakeAmountMock"
  ): TypedContractMethod<[_totalStake: BigNumberish], [void], "nonpayable">;
  getFunction(
